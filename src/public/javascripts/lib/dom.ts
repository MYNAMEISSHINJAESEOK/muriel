...
const dom = {
    ...
    cE : {
        ...
        ,
        select : (id : string, ...args : Array<string | Array<string>  | boolean> ) => {
            const sel = document.createElement('select');
            sel.id = id;
            let boolIndex :number ;
            ...
            optList.forEach ( (arg, i) => {
                if (typeof boolIndex === 'undefined') throw Error('no boolean')
                            ...
                            if (args[boolIndex] === true) {
                                ...
                                if (labelList !== undefined) {
                                    ...
                                    if (Array.isArray(labelList)){
                                        ...
                                        else throw Error(`${label} = label, ${labelList} = labelList, ${i} = index`)
                                    }
